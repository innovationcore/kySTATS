...
def process_query(query, gpt=False):
    ...
    agent = Agent([sdf_1, sdf_2], config={"llm": llm, "verbose": False, "response_parser": StreamlitResponse}, memory_size=10,
...
if __name__ == '__main__':
    ...
    q1 = "What occupation makes the highest early career salary, provide the salary value"
